...
#import "NSDate+KeyBoardExtension.h"

@implementation NSDate (KeyBoardExtension)
...
+(NSString *)getMMSSFromSS:(NSInteger )totalTime{
    ...
    //format of minute
    NSString *str_minute = [NSString stringWithFormat:@"%02d",(seconds/60)%60];
    //format of second
...
+(NSString *)getDDMMSSFromSS:(NSInteger)totalTime{
    ...
    //format of minute
    NSString *str_minute = [NSString stringWithFormat:@"%02ld",(seconds/60)%60];
    //format of second
